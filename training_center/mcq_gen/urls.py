...
urlpatterns = [
    ...
    path('questions_database/question_details/<str:question_id>/edit_question/', views.edit_question, name='edit_question'),
    ...
    path('questions_database/create_question/', views.create_question, name='create_question'),
